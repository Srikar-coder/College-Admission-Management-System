...
public class CollegeAdmission {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "admission_generator_sequence")
    @SequenceGenerator(name = "admission_generator_sequence", sequenceName = "admission_generator_sequence", allocationSize = 1)
    ...
    @Pattern(regexp="(^$|[0-9]{10})",message = "Hall Ticket Number must be 10 digits")
